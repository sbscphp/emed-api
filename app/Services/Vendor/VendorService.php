...
class VendorService
{
    ...
    public function getVendorStats()
    {
        ...
        $mostSuppliedItem = MedicationInventory::select('item_name', DB::raw('SUM(received_qty) as total'))
            ->groupBy('item_name')
            ->orderByDesc('total')
            ->first();
        ...
        return [
            ...
            'most_supplied_item' => $mostSuppliedItem ? $mostSuppliedItem->item_name : null,
        ];
    }
}
