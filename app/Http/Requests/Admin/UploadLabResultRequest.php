...
/**
 * Releasing a laboratory result as a scanned report.
 *
...
class UploadLabResultRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'required|integer|exists:tenant.patient_visit_lab,id',
    ...
    {
        return [
            'id.required' => 'The lab test id is required.',
            'id.exists' => 'Lab test not found.',
