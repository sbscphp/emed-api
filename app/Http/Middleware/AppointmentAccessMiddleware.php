...
/**
 * Guards the appointment module. Appointment belongs to the record role, and to
 * the admins who hold every module.
 */
class AppointmentAccessMiddleware
{
    /**
     ...
     */
    protected const ROLES = ['admin', 'super_admin', 'record'];
