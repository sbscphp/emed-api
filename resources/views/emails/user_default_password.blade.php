...
<body>
    <div class="container">
                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                            ...
                                            <div
                                                ...
                                                <p style="font-size: 14px; line-height: 140%; color: #fff;"><strong>O T
                                                        P&nbsp; &nbsp;V E R I F I C A T I O N&nbsp; &nbsp;</strong></p>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                        style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                style="line-height: 39.2px; font-size: 28px; color: #fff;">Default
                                                                Password
                                                            </span></strong>
                                                    </span>
                                                </p>
        ...
        <span> This is your default password <b>{{ $data['default_password'] }}</b></span>
