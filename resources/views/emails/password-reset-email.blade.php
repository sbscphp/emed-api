                    ...
                    <tr>
                        <td align="center" style="background:#ffffff; padding-top:26px; padding-bottom:8px;">
                            <img src="{{ asset('assets/img/enugu-logo.png') }}"
                                ...
                                style="display:block; width:80px; height:80px; max-width:80px; border:0; outline:none; text-decoration:none;">
                        </td>
                    </tr>
                ...
                --}}
                    ...
                    <tr>
                        <td style="padding:0 40px 26px; color:#374151; font-size:15px; line-height:1.6;">
                            ...
                            <p style="margin:0 0 12px;">
                                Please click the button below to continue to reset your password. Also note that this
                                link
                            ...
                            <p style="margin:18px 0 0; color:#6b7280; font-size:13px;">
                                This email was sent to {{ $data['email'] }}. If you didn't request this, you may safely
                                ignore
                        ...
                        <td align="center"
                            ...
                            <div style="max-width:520px;">
                                ...
                                {{-- <p style="margin:6px 0 0;">
                                    ...
                                    <a href="#" style="display:inline-block; margin:0 6px;"><img
                                            src="{{ asset('assets/img/facebook.png') }}" width="20" alt="Facebook"
                                            style="display:block;border:0;"></a>
                                    <a href="#" style="display:inline-block; margin:0 6px;"><img
