        ...
        Route::group(['middleware' => ["tenant"]], function () {
            ...
            Route::group(['prefix' => 'admin', "namespace" => "v1\Admin"], function () {
                ...
                Route::group(['prefix' => 'service'], function () {
                    ...
                    Route::post('/create_consultation_service', Consultation_Service_Controller::class, "create_consultation_service");
                    Route::put('/edit_consultation_service', Consultation_Service_Controller::class, "edit_consultation_service");
                    Route::get('/all_consultation_service', Consultation_Service_Controller::class, "all_consultation_service");
                });
            });
        });
    });
