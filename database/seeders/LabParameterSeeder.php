    ...
    public function run(): void
    {
        $parameterMap = [
            ...
            'MICROBIOLOGY' => [
                ...
                ['name' => 'Pefloxacin (Gram +ve)', 'code' => 'AST_GP_PEF', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Gentamycin (Gram +ve)', 'code' => 'AST_GP_GEN', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Amp-Clox (Gram +ve)', 'code' => 'AST_GP_AMC', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Zinnacef (Gram +ve)', 'code' => 'AST_GP_ZIN', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Amoxacillin (Gram +ve)', 'code' => 'AST_GP_AMX', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Rocephin (Gram +ve)', 'code' => 'AST_GP_ROC', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Ciprofloxacin (Gram +ve)', 'code' => 'AST_GP_CIP', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Azithromycin (Gram +ve)', 'code' => 'AST_GP_AZI', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Levofloxacin (Gram +ve)', 'code' => 'AST_GP_LEV', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Erythromycin (Gram +ve)', 'code' => 'AST_GP_ERY', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],

                // Gram Negative Antibiotic Sensitivity Panel
                ['name' => 'Lefloxacin (Gram -ve)', 'code' => 'AST_GN_LEF', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Cefotaxin (Gram -ve)', 'code' => 'AST_GN_CEF', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Sparfloxacin (Gram -ve)', 'code' => 'AST_GN_SPA', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Ciprofloxacin (Gram -ve)', 'code' => 'AST_GN_CIP', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Amoxacillin (Gram -ve)', 'code' => 'AST_GN_AMX', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Augmentin (Gram -ve)', 'code' => 'AST_GN_AUG', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Gentamycin (Gram -ve)', 'code' => 'AST_GN_GEN', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Pefloxacin (Gram -ve)', 'code' => 'AST_GN_PEF', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Tarivid (Gram -ve)', 'code' => 'AST_GN_TAR', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
                ['name' => 'Azithromycin (Gram -ve)', 'code' => 'AST_GN_AZI', 'unit' => null, 'reference_range' => 'S/R', 'input_type' => 'checkbox'],
            ],
            'SEROLOGY' => [
            ...
            'URINALYSIS' => [
                ...
                ['name' => 'Protein', 'code' => 'U_PRO', 'unit' => null, 'reference_range' => 'Negative', 'input_type' => 'checkbox'],
                ['name' => 'Sugar', 'code' => 'U_GLU', 'unit' => null, 'reference_range' => 'Negative', 'input_type' => 'checkbox'],
                ['name' => 'Ketone', 'code' => 'U_KET', 'unit' => null, 'reference_range' => 'Negative', 'input_type' => 'checkbox'],
                ['name' => 'Bilirubin', 'code' => 'U_BIL', 'unit' => null, 'reference_range' => 'Negative', 'input_type' => 'checkbox'],
                ['name' => 'Occult Blood', 'code' => 'U_BLD', 'unit' => null, 'reference_range' => 'Negative', 'input_type' => 'checkbox'],
                ['name' => 'Nitrite', 'code' => 'U_NIT', 'unit' => null, 'reference_range' => 'Negative', 'input_type' => 'checkbox'],
                ['name' => 'Leucocyte Esterase (LEU)', 'code' => 'U_LEU', 'unit' => null, 'reference_range' => 'Negative', 'input_type' => 'checkbox'],
                ['name' => 'Urobilinogen', 'code' => 'U_URO', 'unit' => 'mg/dL', 'reference_range' => '0.2 - 1.0', 'input_type' => 'checkbox'],
